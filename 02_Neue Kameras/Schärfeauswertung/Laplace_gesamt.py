...
OUT_DIR  = Path(r"D:\BA\Messungen\Frequenzen\Videos\_Auswertung_Laplace")
...
# NEW: Robust gray (reduce Bayer/demosaic/chroma influence
...
plt.title(f"Schärfemaß (Laplacian-Varianz) vs. Frequenz (ROI {int(ROI_FRAC*100)}% zentral)")
...
print("\n[DONE] Laplacian-Auswertung abgeschlossen.")
